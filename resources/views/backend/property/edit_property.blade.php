    ...
    <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="neighbourhood" class="form-control"value="{{$property->neighbourhood}}">
                    </div>
                </div><!-- Col -->
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="blank">go here to get Latitude address</a>
                    </div>
                </div><!-- Col -->
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        <a href="https://www.latlong.net/convert-address-to-lat-long.html" target="blank">go here to get Longitude address</a>
                    </div>
                </div><!-- Col -->
            </div><!-- Row -->
            ...
            <div class="col-sm-12">
                    <div class="mb-3">
                        ...
                        <textarea name="short_descp" class="form-control" id="exampleFormControlTextarea1" rows="3" >{{$property->short_descp}}</textarea>                    </div>
                </div>
...
<div class="card-body">
    <h6 class="card-title">Edit Main Thambnail</h6>
        <form method="post" action="{{route('update.property.thambnail')}}" id="myForm" enctype="multipart/form-data">
            ...
            <!-- //end main thambnail// (cntrl+/)-->
            
            <!-- //multi image update// (cntrl+/)--> 
