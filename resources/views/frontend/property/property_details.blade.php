        ...
        <section class="property-details property-details-one">
            <div class="auto-container">
                        ...
                        <div class="property-details-content">
                            ...
                            <div class="location-box content-widget">
                                ...
                                <ul class="info clearfix">
                                    ...
                                    <li><span>Neighborhood:</span> {{$property->neighbourhood}}</li>
                ...
                <div class="statistics-box content-widget">
                    ...
                    <iframe width="700" height="400" src="{{$property->property_video}}" title="House sell in Dhaka | jomi soho bari bikri | house sale" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </figure>
                </div>
