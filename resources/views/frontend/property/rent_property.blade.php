...
<form action="{{ route('all.property.serach') }}" method="post" class="search-form">
       @csrf
            ...
            <div class="widget-content">
                ...
                <div class="select-box">
                    <select name="bedrooms" class="wide">
                        <option data-display="Bedrooms">Max Rooms</option>
        ...
        <div class="price-filter sidebar-widget">
                            ...
                            <div class="category-widget sidebar-widget">
                                ...
                                <ul class="category-list clearfix">
                                    <li><a href="property-details.html">For Rent <span>{{ count($rentproperty) }}</span></a></li>
