...
Route::middleware(['auth','role:admin'])->group(function(){
    ...
    Route::controller(PropertyController::class)->group(function(){
        ...
        Route::get('/property/multiimage/delete/{id}', 'PropertyMultiImageDelete')->name('property.multiimg.delete');
...
//Testimonial route
    Route::controller(TestimonialController::class)->group(function(){
        ...
        Route::post('/update/testimonial', 'UpdateTestimonials')->name('update.testimonial');
        Route::get('/delete/testimonial/{id}', 'DeleteTestimonals')->name('delete.testimonials');
...
Route::middleware(['auth','role:agent'])->group(function(){
    ...
    });//end grp agent property middleware
...
//agent details page for frontend
...
//buy property search
Route::post('/buy/property/search', [IndexController::class, 'BuyPropertySearch'])->name('buy.property.serach');

//rent property search
Route::post('/rent/property/search', [IndexController::class, 'RentPropertySearch'])->name('rent.property.serach');
//all property search
Route::post('/all/property/search', [IndexController::class, 'AllPropertySearch'])->name('all.property.serach');
